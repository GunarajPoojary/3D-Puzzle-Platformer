...
namespace PuzzlePlatformer
{
    ...
    public class Interact : MonoBehaviour
    {
        ...
        {
            _playerInputs.PlayerActions.Interact.performed += OnItemInteractPerformed;
        }
        ...
        private bool IsInteractableCloser(IInteractable interactable, IInteractable closestInteractable) => Vector3.Distance(transform.position, interactable.GetTransform().position)
